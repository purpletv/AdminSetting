...
import="eStoreProduct.model.OrderValueWiseShippingCharge,java.util.List"%>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    ...
    <script>
        ...
        function submitEntryForm() {
            ...
            $.ajax({
                ...
                method: 'POST',
                data:{
                    ordvlFrom:ordvlFromValue,
                    ordvlTo:ordvlToValue,
                    ordvlShippingAmount:ordvlShippingAmountValue
                },
                success: function(response) {
                    console.log(response);
                    // Set the response HTML as the inner HTML of the select element
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><%= charge.getOrdvlId() %></td>
            <td><%= charge.getOrdvlFrom() %></td>
            <td><%= charge.getOrdvlTo() %></td>
            <td><%= charge.getOrdvlShippingAmount() %></td>
            <td>
